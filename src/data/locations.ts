...
export const LOCATIONS: Location[] = [
  ...
  loc('shattered-plains', 'Shattered Plains', 'roshar', 'stormlight', 0.845, 0.655, '#f87171', 'storm',
  ...
  loc('narak', 'Narak', 'roshar', 'stormlight', 0.885, 0.705, '#9ca3af', 'drum',
  ...
  loc('yeddaw', 'Yeddaw', 'roshar', 'stormlight', 0.34, 0.665, '#a3e635', 'city',
  ...
  loc('sesemalex-dar', 'Sesemalex Dar', 'roshar', 'stormlight', 0.30, 0.72, '#d97706', 'city',
  ...
  loc('iri', 'Iri', 'roshar', 'stormlight', 0.26, 0.30, '#fde68a', 'land',
    'Northwestern kingdom of gold and long memory, on Shinovar\'s border.'),
  loc('herdaz', 'Herdaz', 'roshar', 'stormlight', 0.72, 0.36, '#fca5a5', 'land',
  ...
  loc('reshi-isles', 'Reshi Isles', 'roshar', 'stormlight', 0.74, 0.28, '#4ade80', 'island',
  ...
  loc('vetitan', 'Vetitan', 'scadrial', 'mistborn1', 0.44, 0.62, '#a8a29e', 'city',
